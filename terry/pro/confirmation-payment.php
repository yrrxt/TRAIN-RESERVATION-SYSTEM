...
.button button {
  ...
  .button button i {
   ...
   <body>
   <div class="container">
    <form action='individual.php?page=paid' method='POST'>
    <div class="price">
    ...
    <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;">Copyright 2023 | TRAIN RESERVATION SYSTEM | NAIROBI RAILWAYS</p>
</div>
   </body>
</html>
