...
.button button {
  ...
  .button button i {
   ...
   <div class="container">
    ...
    <div class="price">
        <h1>Awesome, that's KES 200</h1> <!-- For testing purposes, we have added the amount manually. This should proceed from your website -->
    </div>
    <div class="card__container">
        <div class="card">
            <div class="row">
                    <img src="images/mpesa logo.png" style="width:30%;margin: 0 35%;">
    ...
    <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;">Copyright 2023 | TRAIN RESERVASION SYSTEM | NAIROBI RAILWAYS</p>
</div>
   </body>
</html>