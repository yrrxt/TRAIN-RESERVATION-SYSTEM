...
/*Call function with these configurations*/
    ...
    $type = 4;
    $shortcode = '174379'; 
    $key = "kQPNdOcSgNEEavf8cGAWGU9HlNpnBA0T"; //Put your key here
    $secret = "DZAUUXBbG0GxhgRl";  //Put your secret here
...
/*End transaction code validation*/
    ...
    $endpoint = ($env == "live") ? "https://sandbox.safaricom.co.ke/mpesa/stkpushquery/v1/query" : "https://sandbox.safaricom.co.ke/mpesa/stkpushquery/v1/query"; 
