...
$config = array(
    ...
    "key"              => "kQPNdOcSgNEEavf8cGAWGU9HlNpnBA0T", //Enter your consumer key here
    "secret"           => "DZAUUXBbG0GxhgRl", //Enter your consumer secret here
    "username"         => "apitest",
    ...
    "AccountReference" => "NAIROBI RAILWAYS",
    "TransactionDesc"  => "Payment of Ticket" ,
);
...
if (isset($_POST['phone_number'])) {
    ...
    $endpoint = ($config['env'] == "live") ? "https://sandbox.safaricom.co.ke/mpesa/stkpush/v1/processrequest" : "https://sandbox.safaricom.co.ke/mpesa/stkpush/v1/processrequest"; 
    ...
    if($result['ResponseCode'] === "0"){         //STK Push request successful
        ...
        $conn->query("INSERT INTO `payment`(`Amount`, `Phone`, `CheckoutRequestID`, `MerchantRequestID`) VALUES ('".$amount."','".$phone."','".$CheckoutRequestID."','".$MerchantRequestID."')");
        
        if ($conn->query(("INSERT INTO `payment`(`id`, `Amount`, `Phone`, `CheckoutRequestID`, `MerchantRequestID`) VALUES ('".$user_id."','".$amount."','".$phone."','".$CheckoutRequestID."','".$MerchantRequestID."')")) === TRUE){
