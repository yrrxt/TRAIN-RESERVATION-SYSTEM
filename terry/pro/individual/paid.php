                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered" id='example1'>
                            ...
                            <tbody>
                                <?php
                                $conn = connect()->query("SELECT *, booked.id as id, TransactionDate as pd FROM `booked` INNER JOIN payment ON booked.payment_id = payment.CheckoutRequestID INNER JOIN schedule ON schedule.id = booked.schedule_id  WHERE payment.id = '$user_id' ORDER BY booked.id DESC");
                                $sn = 0;
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p><b>Amount Paid :</b> KES
                                                    <?php echo ($row['amount']);
                                                        ?>
                                                </p>
                                                <p><b>Payment Ref :</b>
                                                    <?php echo ($row['CheckoutRequestID']);
                                                        ?>
                                                </p>
